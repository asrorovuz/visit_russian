    ...
    <div className="px-5">
      ...
      <div className="bg-white rounded-2xl p-4 custom-shadow">
        ...
        <div className="flex flex-wrap gap-1.5 mb-[15px]">
          {list?.slice(0, allTag ? list.length : 4)?.map((item: any, i: number) => (
            <div key={i} className="w-max flex gap-0.5 items-center py-1.5 px-2.5 rounded-md bg-[#F3F6FB] text-[14px] font-normal text-black">
