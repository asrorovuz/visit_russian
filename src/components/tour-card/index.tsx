...
import CustomInputForBirthDay from "../../ui/custom-input-for-birthday";
...
const TourCard = ({ item, index, setCalcData, onRemove, error }: any) => {
  ...
  customInput={<CustomInputForBirthDay />}
  ...
  onChangeRaw={(e) => {
    ...
    if (!dateRegex.test(input)) {
      onChangebirthOfDate(null); // noto‘g‘ri format kiritilsa null qilamiz
    }
  }}
/>
